...
export function Customizer() {
  ...
  return (
    <Sheet>
      <SheetTrigger className="fixed bottom-20 md:bottom-10 end-0 z-50" asChild>
        <Button
          size="icon"
              ...
              <div className="space-y-1.5">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <Button
                      variant={(direction as string) === "rtl" ? "secondary" : "outline"}
                      onClick={() => handleSetLocale("es" as LocaleType)}
                    >
